export const budgetTemplates = [
  {
    ...
    allocation: { living: 70, emergencyFund: 20, longTermAsset: 5, businessLearning: 5, highRiskTrading: 0, debtRepayment: 0 },
    categories: {
  ...
  },
  {
    ...
    allocation: { living: 55, emergencyFund: 15, longTermAsset: 20, businessLearning: 7, highRiskTrading: 3, debtRepayment: 0 },
    categories: {
  ...
  },
  {
    ...
    emergencyTargetMonths: 6,
    allocation: { living: 60, emergencyFund: 10, longTermAsset: 20, businessLearning: 5, highRiskTrading: 5, debtRepayment: 0 },
    categories: {
  ...
  },
  {
    ...
    emergencyTargetMonths: 6,
    allocation: { living: 50, emergencyFund: 25, longTermAsset: 15, businessLearning: 10, highRiskTrading: 0, debtRepayment: 0 },
    categories: {
  ...
  },
  {
    ...
    allocation: { living: 45, emergencyFund: 5, longTermAsset: 35, businessLearning: 10, highRiskTrading: 5, debtRepayment: 0 },
    categories: {
