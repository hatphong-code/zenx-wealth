...
import { auth } from '../../core/services/firebaseAuth';
import { useNumberFormat } from '../../core/hooks/useNumberFormat';
import { getCachedUserProfile, setUserProfileCache, updateTheme, updateLocale } from '../../core/services/userService';
...
function ThemeToggle({ compact = false }) {
  ...
  const changeTheme = async (next) => {
    ...
    try {
      ...
      await updateTheme(user.uid, next);
    } catch {}
  };
